...
- As this is a non-profit initiative of private people, no contributor can give any liability or warranty for the content provided. Our contributors must be protected agains any claims.
- The license shall provide a protection against patent trolling (even if it is unlikely)
- The license shall protect the authorship and copyrights of our contributors.
- If we ever create a trademark, it should be covered/mentioned by the license.
...
There is a large spectrum of open source licenses available ready to use. All open source licenses make the content available to be uses by everyone. This is the core idea of FOSS licenses. So why all these different licenses, which are made for a various set of scenarios? Remember ... usage of the content is already free as it is FOSS. There basically are two major areas they are regulating in different ways:
...
-  The EUPL protects contributors from warranty claims and limits by excluding any warranty by statint the work is provided 'as-is', and making clear that this is an essential part of the license
...
This is absolutely O.K. for us. A lot of open source licenses exclude EVERY liability, but having a closer look at these clauses it becomes clear, that they do not keep up at court.  
In the European Union you cannot exclude liability for wilful misconduct or direct damages to people. You are not allowed to write a software that (somehow) physically harms people and claim that you are not liable for it (crazy idea, right?. Also the application of product liability laws is O.K. for us. As we do not provide a 'product', but simply publish software, they do not apply in our case. Product liability would apply for someone who bundles our software, builds a derivative, and ships it to his customers who pay e.g. for support of the software. 
